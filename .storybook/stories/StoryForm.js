    ...
    render() {
        return (
            <Div row wrap>
                ...
                <Input label="Label" inputList={[{ label: "Value 1" }, { label: "Value 2" }, { label: "Value 3" }, { label: "Value 4" }]}
                    type="checklist" name="test" onChange={(value) => this.setState({ checkList: value })} />
                <Input inputList={[{ label: "Value 1" }, { label: "Value 2" }, { label: "Value 3" }, { label: "Value 4" }]}
